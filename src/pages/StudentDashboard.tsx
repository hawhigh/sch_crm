...
export const StudentDashboard = () => {
  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
      ...
      <section className="relative overflow-hidden rounded-[48px] bg-primary text-white p-16 min-h-[460px] flex flex-col justify-between shadow-2xl">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-white/5 blur-[100px] rounded-full translate-x-1/3 -translate-y-1/3 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[var(--secondary)]/10 blur-[80px] rounded-full -translate-x-1/2 translate-y-1/2 pointer-events-none" />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
        ...
        <div className="xl:col-span-8 space-y-16">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {progress?.map((p: any) => (
                <div key={p.subject} className="bg-surface-low p-10 rounded-[40px] flex flex-col justify-between group hover:bg-white transition-all duration-500 shadow-sm border border-transparent hover:border-[#454557]/5">
                  <div className="flex justify-between items-start mb-12">
                    ...
                    <Badge variant="primary" size="md" className="rounded-2xl">{p.percentComplete}%</Badge>
                  </div>
                  <div>
                    <div className="w-full h-2.5 bg-[#e4e2de] rounded-full overflow-hidden mb-5">
                      <div className="h-full bg-primary rounded-full transition-all duration-[2000ms] ease-out w-0" style={{ width: `${p.percentComplete}%` }} />
                    </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {materials?.length > 0 ? materials.map((m: any) => (
                <div key={m.id} className="bg-surface-low p-8 rounded-[40px] group cursor-pointer hover:bg-white transition-all duration-500 border border-transparent hover:border-[#454557]/5">
                  <div className="flex items-center gap-6 mb-8">
                    <div className="w-14 h-14 rounded-[20px] bg-white flex items-center justify-center text-[#303030] group-hover:bg-primary group-hover:text-white transition-all duration-300 shadow-sm">
                      <BookOpen size={24} />
                    </div>
                  ...
                  <div className="pt-6 border-t border-[#454557]/5 flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="sm" className="w-10 h-10 p-0 rounded-full" icon={<ArrowRight size={18} />} />
                  </div>
                </div>
              )) : (
                <div className="col-span-2 p-20 flex flex-col items-center text-center bg-surface-low rounded-[40px] border border-dashed border-[#454557]/20">
                  <div className="w-20 h-20 bg-white rounded-[24px] flex items-center justify-center mb-6 text-[#454557]/10 shadow-sm">
                    <BookOpen size={40} />
                  </div>
        ...
        <aside className="xl:col-span-4 space-y-12">
          ...
          <section className="bg-surface-low rounded-[48px] p-10 shadow-sm border border-[#454557]/5">
          ...
          <section className="bg-[#303030] p-12 rounded-[48px] text-white relative overflow-hidden group shadow-xl">
          ...
          <div className="bg-white p-8 rounded-[40px] border border-[#454557]/10 flex items-center gap-6 shadow-sm">
            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-primary/20 bg-surface-low grow-0 shrink-0">
